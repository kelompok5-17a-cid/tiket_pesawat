...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Feb 2020 pada 12.10
...
(6, 'deden', 'komplek', '081217771818', 16, 'L', 'Bandung', '0000-00-00'),
(7, 'Elsa', 'Soetta', '082119918576', 21, 'P', 'Jakarta', '1998-02-28');
...
(7, 'D0007', '005', '2020-02-29', 5, 50000, '250000'),
(8, 'D0008', 'D0007', '2020-02-20', 5, 50000, '250000');
...
(5, 'D0005', '2020-02-29', '08:10:00', 'CMH'),
(6, 'D0006', '2020-03-02', '10:40:00', 'BDG'),
(7, 'D0007', '2020-02-20', '14:30:00', 'BTM');
...
--
ALTER TABLE `tbl_konsumen`
  MODIFY `no_identitas` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_tiket`
  MODIFY `no_identitas` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tbl_tujuan`
--
ALTER TABLE `tbl_tujuan`
  MODIFY `no_identitas` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
